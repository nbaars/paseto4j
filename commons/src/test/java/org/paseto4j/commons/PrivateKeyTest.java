...
class PrivateKeyTest {
    ...
    private static Stream<Arguments> combinations() {
        return Stream.of(
                Arguments.of(PRIVATE_KEY, Version.V1, Purpose.PURPOSE_PUBLIC, true),
                Arguments.of(PRIVATE_KEY, Version.V1, Purpose.PURPOSE_LOCAL, false),
                Arguments.of(PRIVATE_KEY, Version.V2, Purpose.PURPOSE_PUBLIC, true),
                Arguments.of(PRIVATE_KEY, Version.V2, Purpose.PURPOSE_LOCAL, false));
    }

    @ParameterizedTest
    @MethodSource("combinations")
    void verifyCombinations(String privateKey, Version version, Purpose purpose, boolean expectedResult) {
        var key = new PrivateKey(privateKey.getBytes(StandardCharsets.UTF_8), version);
